...
if (command == 'attp2') {
conn.sendFile(m.chat, `https://api.betabotz.eu.org/api/maker/attp?text=${teks}&apikey=${global.lann}`, 'sticker.webp', '', m, { asSticker: true })}
    
if (command == 'attp3') {
conn.sendFile(m.chat, `https://api.betabotz.eu.org/api/maker/attp?text=${teks}&apikey=${global.lann}`, 'sticker.webp', '', m, { asSticker: true })}

if (command == 'ttp5') {
conn.sendFile(m.chat, `https://api.betabotz.eu.org/api/maker/ttp?text=${teks}&apikey=${global.lann}`, 'sticker.webp', '', m, { asSticker: true })}
