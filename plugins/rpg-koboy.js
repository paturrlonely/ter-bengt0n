const handler = async (m, { conn }) => {
  ...
  if (conn.koboy[m.chat]) return m.reply('Kamu sedang bermain game Koboy! Tunggu 20 menit lagi untuk memulai lagi.');
...
Wilayah penjahat:
${"・".repeat(criminalPosition)}🥷${"・".repeat(5 - criminalPosition)}
Reply ketik *'kanan'* untuk bergerak ke kanan.
Reply ketik *'kiri'* untuk bergerak ke kiri.`;
