    ...
    try {
        ...
        if (m.mentionedJid && m.mentionedJid.length > 0) {
            ...
            if (isMention) {
                ...
                const messages = [
                    { role: "system", content: "kamu adalah AETHERZ-MD, Seorang Asisten pribadi yang di buat oleh betabotz yang siap membantu kapan pun, jawab setiap pertanyaan menggunakan emoticon dan seramah mungkin kepada user jangan lupa sertakan lelcuon pada jawaban yang membuat user betah:)!" },
                    { role: "assistant", content: `Saya AETHERZ-MD, asisten pribadi yang siap membantu kamu kapan pun! Apa yang bisa saya bantu hari ini?` },
